...
object FirebaseCloudRemoteModule {
    const val Firebase_Cloud_BASE_URL =
        "https://us-central1-quoteapplication-45b67.cloudfunctions.net/"

    fun createRemoteModule() = module {
        val baseUrl = Firebase_Cloud_BASE_URL
        single {
