...
import com.oyetech.models.radioModels.PauseReason.NONE
...
import com.oyetech.audioPlayerHelper.R
import com.oyetech.audioPlayerHelper.R.string
import com.oyetech.audioPlayerHelper.notificationHelper.RadioNotificationHelper
...
class MediaSessionHelper(private var service: Service) : PlayerBroadcastHelper(service) {
    ...
    private fun setMediaPlaybackState(state: Int) {
        ...
        if (state == PlaybackStateCompat.STATE_ERROR) {
            ...
            val currentPlayerState: PlayState = contentOperationUseCase.getPlayerState()
    ...
    fun updateNotification(radioModel: ContentStateView) {
        ...
        var currentStationName = radioDataModel.contentName ?: ""
        ...
        when (playState) {
            ...
            PrePlaying -> {
                notificationHelper.sendMessage(
                    ...
                    radioLogo = radioDataModel.contentIcon
                )
            ...
            Playing -> {
                ...
                val title: String = radioDataModel.contentTitle
